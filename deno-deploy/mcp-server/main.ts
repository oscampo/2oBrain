...
mcp.tool('remember', {
  ...
  handler: async (args: {
    ...
    // alguno de ellos ademas del recuerdo primario.
    ...
    // por supersedes, avisa (nunca bloquea, hay citas legítimas). Este
    // deploy no soporta complements todavía, así que lo único "cubierto"
    // es supersedesIds.
